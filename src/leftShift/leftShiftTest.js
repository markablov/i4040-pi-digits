...
import { hexToHWNumber, hwNumberToHex } from '../common/numbers.js';
import { compileCode } from '../common/compile.js';

import {
  addInitializationWithTestValues, generateMemoryMainCharactersInitialization, generateRegisterInitialization,
} from '../common/codeGenerator.js';
...
const TESTS = [
  ...
  // 0x8234567890000000 << 2 === 0x208d159e240000000, but MSD should be transferred to lowest word, because of number width
  { input: { value: '0x8234567890000000', shiftCount: 2 }, expected: '0x8D159E240000002' }
];

const test = async () => {
  const { rom, sourceCode } = await compileCode('leftShift/leftShift.i4040');
